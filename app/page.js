...
function HomeContent() {
  ...
  return (
    <div>
      ...
      {/* About Us Section */}
      <section
        className="py-12 sm:py-16 md:py-20 bg-white px-3 sm:px-4 md:px-6 lg:px-8"
        id="about"
      >
      ...
      <section
        className="py-12 sm:py-16 md:py-20 bg-gray-50 px-3 sm:px-4 md:px-6 lg:px-8"
        id="alumni-review"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto px-2">
              Hear from our successful candidates who have transformed their
              careers
            </p>
          </div>
