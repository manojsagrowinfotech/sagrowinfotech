...
export const metadata = {
  title: "Services",
  description:
    "Explore our comprehensive placement programs across multiple technology domains.",
};
              ...
              <div className="p-6 sm:p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {category.roles.map((role, roleIndex) => (
                    <div
                      key={roleIndex}
                      className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-300 rounded-lg p-4 sm:p-5 hover:from-primary-50 hover:to-blue-50 hover:border-primary-400 transition-all duration-200 group"
                    >
